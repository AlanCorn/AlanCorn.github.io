    ...
    <div class="hero" :style="{ ...bgImageStyle }">
      <div>
        ...
        <ModuleTransition delay="0.04">
          <h1 v-if="recoShowModule && $frontmatter.heroText !== null" class="poemFont">
            {{poem || $frontmatter.heroText || $title || 'vuePress-theme-reco' }}
          </h1>
        </ModuleTransition>

        <ModuleTransition delay="0.08">
          <div class="flex-container">
            <span v-if="recoShowModule && $frontmatter.tagline !== null" class="description poemFont">
              「{{title || $frontmatter.tagline || $description || 'Welcome to your vuePress-theme-reco site' }}」
            </span>
            <span class="authorTag poemFont">{{author}}</span>
          </div>
        </ModuleTransition>
      </div>
    </div>
  ...
  setup (props, ctx) {
    ...
    onMounted(() => {
      ...
      jinrishici.load(result => {
        poem.poem = result.data.content
        poem.author = result.data.origin.author
        poem.title = result.data.origin.title
    ...
    return { recoShowModule, heroImageStyle, bgImageStyle, ...toRefs(state), getOneColor , ...toRefs(poem)}
  },
  methods: {
